...
const TOPOLOGIES = [
  ...
  },
  {
    ...
    devices: [
      ...
      { id: 'core_switch', type: 'switch', label: 'Корневой комм.', x: 340, y: 230,
  ...
  },
  {
    ...
    devices: [
      { id: 'office1_r', type: 'router', label: 'Офис 1
Роутер', x: 120, y: 80,
      ...
      { id: 'office2_r', type: 'router', label: 'Офис 2
Роутер', x: 560, y: 80,
  ...
  },
  {
    ...
    devices: [
      ...
      { id: 'server', type: 'server', label: 'Сервер', x: 180, y: 320, broken: true, info: { title: 'Сервер (проблема!)', desc: 'Соединение со свитчем оборвано! Порт не подходит пинг от ПК.', cmds: ['ping [server_ip]', 'show interfaces', 'cable test'] } },
      { id: 'pc', type: 'pc', label: 'ПК', x: 500, y: 320, info: { title: 'ПК', desc: 'Не может достучься до сервера.', cmds: ['ping [server_ip]', 'tracert [server_ip]'] } },
    ],
    links: [
