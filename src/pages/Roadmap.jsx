...
const STAGES = [
  {
    ...
    icon: '🖥️',
    color: '#00aaff',
    desc: 'Понимание принципов работы операционных систем Linux и Windows',
    topics: [
      ...
      { id: 't6', label: 'Systemd: юниты, journalctl', done: false },
    ]
  },
  {
    id: 2,
    ...
    topics: [
      ...
      { id: 'n6', label: 'VPN: OpenVPN / WireGuard', done: false },
    ]
  },
  {
    id: 3,
    ...
    topics: [
      ...
      { id: 'w2', label: 'Apache: .htaccess, mod_rewrite', done: false },
      { id: 'w3', label: 'SSL/TLS: Let\'s Encrypt, certbot', done: false },
      { id: 'w4', label: 'HTTP/2, gzip, кэширование', done: false },
  ...
  },
  {
    ...
    topics: [
      { id: 'd1', label: 'PostgreSQL: установка, роли, бэкап', done: false },
      { id: 'd2', label: 'MySQL / MariaDB: репликация', done: false },
      { id: 'd3', label: 'Redis: кэш и сессии', done: false },
      { id: 'd4', label: 'Мониторинг запросов, EXPLAIN', done: false },
    ]
  },
  {
    id: 5,
    ...
    topics: [
      { id: 'a1', label: 'Bash-скриптинг: циклы, функции, cron', done: false },
      { id: 'a2', label: 'Ansible: playbooks, роли, vault', done: false },
      { id: 'a3', label: 'Terraform: основы IaC', done: false },
      { id: 'a4', label: 'Git: базовые операции', done: false },
      { id: 'a5', label: 'CI/CD: GitLab CI / GitHub Actions', done: false },
    ]
  },
  {
    id: 6,
    ...
    topics: [
      { id: 'c1', label: 'Docker: образы, контейнеры, Dockerfile', done: false },
      { id: 'c2', label: 'Docker Compose: многосервисные приложения', done: false },
      { id: 'c3', label: 'Kubernetes: Pod, Deployment, Service', done: false },
      { id: 'c4', label: 'Helm: charts и релизы', done: false },
      { id: 'c5', label: 'Container registry, образы безопасности', done: false },
    ]
  },
  {
    id: 7,
    ...
    icon: '📊',
    color: '#ff3d57',
    desc: 'Наблюдаемость, логи, алерты',
    topics: [
      { id: 'm1', label: 'Prometheus + Grafana', done: false },
      { id: 'm2', label: 'Zabbix: агенты, триггеры', done: false },
      { id: 'm3', label: 'ELK Stack: Elasticsearch, Logstash, Kibana', done: false },
      { id: 'm4', label: 'Алертинг: PagerDuty, Alertmanager', done: false },
      { id: 'm5', label: 'Трейсинг: Jaeger / Zipkin', done: false },
    ]
  },
  {
    id: 8,
    ...
    topics: [
      { id: 's1', label: 'SSH: ключи, 2FA, fail2ban', done: false },
      { id: 's2', label: 'SELinux / AppArmor', done: false },
      { id: 's3', label: 'Аудит: auditd, логи безопасности', done: false },
      { id: 's4', label: 'Сканеры: nmap, lynis, OpenVAS', done: false },
