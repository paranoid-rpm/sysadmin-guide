    ...
    sections: [
      ...
      },
      {
        ...
        skills: [
          ...
          { name: 'SSH: подключение, ключи', must: true },
        ]
      },
      {
        title: 'Инструменты',
    ...
    sections: [
      ...
      },
      {
        ...
        skills: [
          ...
          { name: 'tcpdump, Wireshark', must: true },
          { name: 'BGP / OSPF основы', must: false },
      ...
      },
      {
        title: 'Автоматизация',
        skills: [
          { name: 'Ansible: playbooks, роли', must: true },
          { name: 'CI/CD: GitLab CI / GitHub Actions', must: true },
          { name: 'Docker Compose', must: true },
          { name: 'Terraform основы', must: true },
          { name: 'Python-скрипты для автоматизации', must: false },
        ]
      },
      {
        title: 'Базы данных',
    ...
    sections: [
      {
        ...
        skills: [
          ...
          { name: 'Service Mesh: Istio / Linkerd', must: true },
          { name: 'Infrastructure as Code (Terraform)', must: true },
          { name: 'GitOps: ArgoCD / Flux', must: true },
      ...
      },
      {
        ...
        skills: [
          ...
          { name: 'Incident management / post-mortem', must: true },
    ...
    <div>
      ...
      <div className="skills-levels">
        {LEVELS.map(l => (
          ...
          >
            <span className="slb-icon">{l.icon}</span>
